...
| Accepted ADR | [0001-domain-periodic-contracts.md](adr/0001-domain-periodic-contracts.md) | Accepted decisions | Contracts and repairs for `field.hpp`, periodic validity, reduction, and documentation | Domain, Periodic, bandwidth, offset, F1, F2, F3, F4 |
